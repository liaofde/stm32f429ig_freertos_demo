...
#else
#    define MSG_ERR(num, str, val)   printf("MSG_ERR[0x%X]:%s0x%X\r\n",num,str,val)//do{}while(0)//printf("MSG_ERR[0x%X]:%s0x%X\r\n",num,str,val)
#endif
...
#    define MSG_WAR(num, str, val)          \
        ...
        printSCI_nbr(SCI0, val, '\n');
#else
#    define MSG_WAR(num, str, val)   do{}while(0)//printf("MSG_WAR[0x%x]:%s0x%X\r\n",num,str,val)//do{}while(0)//printf("MSG_WAR[0x%x]:%s0x%X\r\n",num,str,val)
#endif
